...
void R_Register( void ) 
{
	...
	r_lightallGreyscale = ri.Cvar_Get("r_lightallGreyscale", "0", CVAR_ARCHIVE | CVAR_LATCH);
	ri.Cvar_CheckRange(r_lightallGreyscale, 0, 1, qfalse);
